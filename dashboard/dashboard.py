...
def explore_categories_city(df):
    category_highest = df.groupby(['customer_city', 'product_category_name']).agg({
        'product_id': 'count'  
...
explore_categories_city_data = explore_categories_city(main_df)
...
sns.barplot(x='customer_city', y='count', hue='product_category_name', data=top_3_categories_per_city)
